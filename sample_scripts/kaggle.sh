...
kaggle datasets download -p datasets --unzip username/datasetname

#"-p datasets": create a subdirectory called datasets and place the downloaded file(s) there
#"--unzip": unzips the downloaded file, will delete the zip file when completed
#run "kaggle datasets download -h" for additional information
